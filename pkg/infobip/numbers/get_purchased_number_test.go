...
func TestGetPurchasedNumberValidReq(t *testing.T) {
	...
	serv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		assert.True(t, strings.HasSuffix(r.URL.Path, fmt.Sprintf(getpurchasedNumberPath, numberKey)))
	...
	msgResp, respDetails, err := number.GetPurchasedNumber(context.Background(), numberKey)
