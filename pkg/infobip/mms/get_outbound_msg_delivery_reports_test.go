...
func TestGetOutboundMsgDeliveryReportsValidReq(t *testing.T) {
	...
	tests := []struct {
		...
		{scenario: "No params passed", params: models.OutboundMsgDeliveryReportsOpts{}, expectedParams: ""},
		{
	...
	for _, tc := range tests {
		t.Run(tc.scenario, func(t *testing.T) {
			serv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
				assert.True(t, strings.HasSuffix(r.URL.Path, getOutboundMsgDeliveryReportsPath))
