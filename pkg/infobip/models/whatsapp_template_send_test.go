						...
						Content: TemplateMsgContent{
							...
							TemplateData: TemplateData{
								...
								Buttons: []TemplateMsgButton{
									...
									{Type: "QUICK_REPLY", Parameter: "value5"},
									{Type: "QUICK_REPLY", Parameter: "value6"},
									{Type: "QUICK_REPLY", Parameter: "value7"},
									{Type: "QUICK_REPLY", Parameter: "value8"},
									{Type: "QUICK_REPLY", Parameter: "value9"},
									{Type: "QUICK_REPLY", Parameter: "value10"},
									{Type: "QUICK_REPLY", Parameter: "value11"},
								},
							},
							Language: "en_GB",
						},
